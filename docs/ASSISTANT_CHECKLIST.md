...
### **Lesson 05: オーディオエフェクトとダイナミクス**
- [ ] エフェクトの効果が劇的に体験できるか
- [ ] リバーブ、ディレイ、コーラスの原理が分かるか
- [ ] ダイナミクス（音量制御）の基本が理解できるか
...
### **教員への報告**
- 技術的な不具合 → GitHub Issues でフィードバック投稿
- それ以外 → Discordの「教育・SA」カテゴリ内「基礎ゼミ」チャンネルに投稿
